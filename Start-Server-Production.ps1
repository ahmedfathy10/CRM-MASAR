# Masar CRM Production Server Startup Script (PowerShell)
# Usage: .\Start-Server-Production.ps1

Set-Location $PSScriptRoot

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Masar CRM Server - Production Build" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
