...
const catalogForms:{key:string;name:string;description:string;fields:FieldSeed[]}[] = [
  ...
  {key:"education_batch",name:"الدفعة التعليمية",description:"بيانات Education Batches",fields:[["trackId","الـTrack","select","اختر الـTrack",1,1,1,"full","[]"],["title","اسم الدفعة","text","مثال: B15 - English",1,1,2,"full","[]"],["startDate","تاريخ البداية","date","",1,1,3,"half","[]"],["isActive","الحالة","select","اختر الحالة",1,1,4,"half",'["نشط","غير نشط"]']]},
  {key:"group",name:"المجموعة",description:"بيانات Groups",fields:[["batchId","الدفعة","select","اختر الدفعة",1,1,1,"full","[]"],["title","اسم المجموعة","text","مثال: Group A",1,1,2,"full","[]"],["branchId","الفرع","select","اختر الفرع",1,1,3,"half","[]"],["levelId","المستوى","select","اختر المستوى",1,1,4,"half","[]"],["studyTypeId","نوع الدراسة","select","اختر النوع",1,1,5,"half","[]"],["timeSlotId","موعد الدراسة","select","اختر الموعد",1,1,6,"half","[]"],["classroomId","القاعة","select","اختر القاعة",1,1,7,"half","[]"],["capacity","السعة","number","عدد الطلاب",1,1,8,"half","[]"],["isActive","الحالة","select","اختر الحالة",1,1,9,"full",'["نشط","غير نشط"]']]},
