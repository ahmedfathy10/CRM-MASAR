...
const catalogForms:{key:string;name:string;description:string;fields:FieldSeed[]}[] = [
  ...
  {key:"round",name:"الجولة",description:"بيانات Rounds",fields:[["title","اسم الجولة","text","مثال: Round 1",1,1,1,"full","[]"],["lectureCount","عدد المحاضرات","number","مثال: 12",1,1,2,"half","[]"],["lectureDuration","مدة المحاضرة بالدقائق","number","مثال: 90",1,1,3,"half","[]"],["isActive","الحالة","select","اختر الحالة",1,1,4,"full",'["نشط","غير نشط"]']]},
